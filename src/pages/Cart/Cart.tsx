...
export default function Cart() {
    ...
    const totalCheckedPurchasePrice = useMemo(
        () =>
            checkedPurchases.reduce((result, current) => {
                return result + current.product.sellingPrice * current.quantity
            }, 0),
        [checkedPurchases]
    )
    const totalCheckedPurchaseSavingPrice = useMemo(
        () =>
            checkedPurchases.reduce((result, current) => {
                return result + (current.product.originalPrice - current.product.sellingPrice) * current.quantity
            }, 0),
        [checkedPurchases]
    )
    ...
    //     const purchasesIds = checkedPurchases.map((purchase) => purchase.id)
            ...
            <div className='container'>
                {extendedPurchases.length > 0 ? (
                    ...
                    <div className='text-center'>
                        <img src={require('../../assets/images/no-product.png')} alt='no purchase' className='mx-auto h-24 w-24' />
