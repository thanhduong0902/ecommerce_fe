...
import { getAccessTokenFromLS, setProfileToLS } from '../../../../utils/auth'
...
export default function Profile() {
    ...
    const { data: profileData, refetch } = useQuery({
        queryKey: ['profile'],
        queryFn: () => userApi.getProfile(token),
    });
    ...
    useEffect(() => {
        if (profileUser) {
            setValue('name', profileUser.data.name?.lastName)
            setValue('phone', profileUser.data.phone)
            setValue('address', profileUser.data.address)
            setValue('avatar', profileUser.data.avatar)
                ...
                <form className='mt-8 flex flex-col-reverse md:flex-row md:items-start' onSubmit={onSubmit}>
                    <div className='mt-6 flex-grow md:mt-0 md:pr-12'>
                        <div className='flex flex-col flex-wrap sm:flex-row'>
                            ...
                            <div className='sm:w-[80%] sm:pl-5'>
                                <div className='pt-3 text-gray-700'>{profileUser?.data.email}</div>
                            </div>
                        </div>
                        <Info />
                        <div className='mt-2 flex flex-col flex-wrap sm:flex-row'>
