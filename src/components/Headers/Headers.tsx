                ...
                <div className='mt-4 grid grid-cols-12 items-end gap-4'>
                    ...
                    >
                        <div className='flex rounded-sm bg-white p-1'>
                            ...
                            // {...register('name')}
                            />
                            <button className='flex-shrink-0 rounded-sm bg-pink-400 px-6 py-2 hover:opacity-90'
                                type='submit'
                            >
                                <svg
                                ...
                                <div className='relative  max-w-[400px] rounded-sm border border-gray-200 bg-white text-sm shadow-md'>
                                    {purchasesInCart && purchasesInCart.length > 0 ? (
                                        <div className='p-2'>
                                            ...
                                            <div className='mt-5'>
                                                {purchasesInCart.slice(0, MAX_PURCHASES).map((purchase) => (
                                                    <div className='mt-2 flex py-2 hover:bg-gray-100' key={purchase.id}>
                                                        ...
                                                        <div className='ml-2 flex-shrink-0'>
                                                            <span className='text-orange'>₫{formatCurrency(purchase.product.sellingPrice)}</span>
                                                        </div>
                                                    </div>
                                                ))}
                                            </div>
                                        ...
                                        <div className='flex h-[300px] w-[300px] flex-col items-center justify-center p-2'>
                                            <img src={require('../../assets/images/no-product.png')} alt='no purchase' className='h-24 w-24' />
